...
my $Domains = {
	...
	'mailcom' => [
		...
		# 9-10 characters(.com)
		qr{\A(?:allergist|bikerider|columnist|cyberdude|diplomats|disciples|financier|galaxyhit|geologist|handy[-]man)[.]com\z},
		qr{\A(?:hilarious|mailpuppy|pakistans|publicist|radiostar|religions|religious|repairman|scientist|selfware|singapore|snakebite)[.]com\z},
